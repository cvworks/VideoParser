...
// Code from: http://public.cranfield.ac.uk/c5354/teaching/dip/opencv/lecture_demos/contour_tree_recognition.cc
	  ...
	  while (keepProcessing) {
		  ...
		  if (largest_contour != NULL)
		 {
			...
			if (modelBuilding) {
				...
				data_tree = cvCreateContourTree(largest_contour, data_tree_storage, 0);				
			}
		  }
