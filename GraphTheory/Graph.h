...
/*!
	...
	The main characteristic of this library and its derived
	AttributedGraph<T> class is that:
...
public:
	...
	void set_directed(bool isDirected)
	{
		// @TODO currently this only works with "empty" graphs
		ASSERT(empty());
