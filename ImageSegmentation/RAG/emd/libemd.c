...
static float init(emd_signature_t *Signature1, emd_signature_t *Signature2,
...
float emd(emd_signature_t *Signature1, emd_signature_t *Signature2,
	  float (*Dist)(emd_feature_t *, emd_feature_t *), emd_flow_t *Flow, int *FlowSize)
...
where
   ...
   Flow       (Optional) Pointer to a vector of emd_flow_t (defined in emd.h) 
