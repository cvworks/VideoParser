...
testing
gen_comb_rep_init()and gen_comb_rep_next()

compile
gcc -o comb_rep_example comb_rep_example.c comb_rep.c
*/
...
//initialize
gen_result = gen_comb_rep_init(vector, n, k);
...
while(gen_result == GEN_NEXT)
 ...
 gen_result = gen_comb_rep_next(vector, n, k);
 }
